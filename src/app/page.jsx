...
import tandymIcon from '@/images/logos/tandym-icon.png'
import gorillaLogo from '@/images/logos/gorilla-logic.jpeg'
import devbaseLogo from '@/images/logos/devbase.jpeg'
import freelanceLogo from '@/images/logos/open-shuttle.svg'
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://twitter.com/jmprada88"
              aria-label="Follow on Twitter or X ?"
              icon={TwitterIcon}
            />
            <SocialLink
              href="https://www.instagram.com/jmprada88"
              aria-label="Follow on Instagram"
              icon={InstagramIcon}
            />
            <SocialLink
              href="https://github.com/jmprada1988"
              aria-label="Follow on GitHub"
              icon={GitHubIcon}
            />
            <SocialLink
              href="https://www.linkedin.com/in/juanma-profile"
